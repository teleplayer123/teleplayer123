...
| [Fractal Visuals](https://github.com/teleplayer123/fractals_visuals) | Windows views of fractal patterns changing over time. |
...
| Project Name | Description |
| :--- | :--- |
| [Audio Recognition](https://github.com/teleplayer123/audio_recognition) | ML model for audio classification using embedded platforms. |
| [Image Classifier](https://github.com/teleplayer123/image_classifier) | Deep learning model for visual classification. |
